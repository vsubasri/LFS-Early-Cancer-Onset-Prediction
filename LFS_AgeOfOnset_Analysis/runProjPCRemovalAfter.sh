#!/bin/bash
#PBS -S /bin/bash
#PBS -e log/log.PCAreconstruction.err
#PBS -o log/log.PCAreconstruction.out
#PBS -l vmem=48g
#PBS -l mem=48g
...
Rscript /hpf/largeprojects/adam/projects/lfs/lfs_germline/methyl_data/Scripts/PCAreconstruction_Project.R \
