...
cutoff <- ROCobj_test[[5]]
rf_results <- pred_cancer_rf_test(rf_model, data_test,72,args$sex,args$array,args$canceratdraw,args$systreat,genes)
...
enet_results <- pred_cancer_enet_test(enet_model, lambda_index,data_test,72,args$sex,args$array,args$canceratdraw,args$systreat,genes)
...
cutoff <- ROCobj_test[[5]]
svmlinear_results <- pred_cancer_svm_test(svmlinear_model, data_test,72,args$sex,args$array,args$canceratdraw,args$systreat,genes,"svmLinear")
...
cutoff <- ROCobj_test[[5]]
svmradial_results <- pred_cancer_svm_test(svmradial_model, data_test,72,args$sex,args$array,args$canceratdraw,args$systreat,genes,"svmRadial")
...
cutoff <- ROCobj_test[[5]]
gbm_results <- pred_cancer_gbm_test(gbm_model, data_test,72,args$sex,args$array,args$canceratdraw,args$systreat,genes)
cat(paste0("[ Get prediction metrics for gbm ]","\n"))
